...
int32_t DrvI2S_Open(S_DRVI2S_DATA_T *sParam)
{
	...
	I2S->CON.WORDWIDTH 	= sParam->u8WordWidth;
	I2S->CON.MONO 		= sParam->u8AudioFormat;
	I2S->CON.FORMAT 	= sParam->u8DataFormat;
	I2S->CON.SLAVE 		= sParam->u8Mode;
	I2S->CON.TXTH 		= sParam->u8TxFIFOThreshold;
	I2S->CON.RXTH 		= sParam->u8RxFIFOThreshold - 1;
